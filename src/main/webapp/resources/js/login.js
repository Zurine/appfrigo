...
function load()
{
	var date = new Date()
	 var offset = date.getTimezoneOffset();
//	alert('oof' +offset );
//	alert('mom'+ moment().format("Z"));
	
//	var d = new Date(); // or whatever date you have
//	var tzName = d.toLocaleString('en', {timeZoneName:'short'}).split(' ').pop();
//	alert('tzName' + tzName);
//	var offset = (new Date()).getTimezoneOffset();
//	alert('asdasd'+new Date('Feb 28 2013 19:00:00 GMT-0500').toString())
	
	var tz = jstz.determine();
    tz.name();
//    alert('tz' +  tz.name());
//	var tzName = moment.tz.guess();
//	var abbr = moment.tz(tzName).zoneAbbr();  // or .format('z')
//	alert('abbr' + abbr);
//	var timezones = {
...
//
////	alert('url' +  $('#web-url').val())
//	var tz = moment.tz(moment.tz.guess()).format("z");
////	alert(moment.tz.zone(tz.name()).abbr(new Date().getTime()));
	
	
//	alert('g' + moment().format("Z"));
	$.ajax({
	    'url':  $('#web-url').val()+'setDefault?timezone='+tz.name(),
	    'type': 'GET',
//	    'data': $('form').serialize(),
